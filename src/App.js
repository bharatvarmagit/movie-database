...
function App() {
     ...
     console.log("Searching for",searchText)
      ...
      setSearchResults(prev=>{
        if(searchText===prev.searchText){
         ...
         return {[page]:jsonResponse.results,total_pages:jsonResponse.total_pages,searchText}
         }
      })
  ...
  return (
    <div className="App">
      ...
      <Pagination count={trendingMovies.total_pages} color="primary" page={page} onChange={handlePagination}/>
        }
        {searchResults['1']&&
